...
Algorithm 1: gbd_search_q_contract(G1, G2, s, q, S_list, target_w,
  ...
  collision_depth: fraction d ∈ [0,1] (early stopping window)
  ...
  1. Precompute the full left list  L1 = { m1·G1 : m1 ∈ F_q^{k1} } and the
     full right list L2 = { m2·G2 : m2 ∈ F_q^{k2} } together with their
